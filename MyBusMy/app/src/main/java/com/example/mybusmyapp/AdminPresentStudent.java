...
public class AdminPresentStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_present_student);

        listView=findViewById(R.id.listAdminPresentStudent);
        // Make network request to retrieve student data
        String response = Network.connect("http://" + Network.IP + "/showAdminpresentstudent.php", new HashMap<String, String>());
