...
public class Certi5 extends AppCompatActivity {
    TextView name,date,grade;
    ImageView cert,sign;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_certi5);
        name=findViewById(R.id.nameTextView4);
        date=findViewById(R.id.dateTextView4);
        grade=findViewById(R.id.gradeTextView4);
        cert=findViewById(R.id.certificateImage4);
        sign=findViewById(R.id.signTextView4);
        String id=getIntent().getStringExtra("id");
        Button btn=findViewById(R.id.next4);
