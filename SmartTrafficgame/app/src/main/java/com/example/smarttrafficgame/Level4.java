...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                if (marks < 3) {
                   showScannedDataDialog();
                    ...
                    Intent intent = new Intent(getApplicationContext(), Certi4.class);
        ...
        System.out.println(id);
        String rs = Network.connect("http://" + Network.IP + "/level4.php", p);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (dialog != null && dialog.isShowing()) {
                    Toast.makeText(Level4.this, "YOU ARE FAIL SECOND EXAM", Toast.LENGTH_SHORT).show();
                    HashMap<String ,String > p2=new HashMap<String ,String>();
                    p2.put("user_id",id.trim());
                    System.out.println(id);
                    String rs2=Network.connect("http://"+Network.IP+"/delete_level4.php",p2);
                    Intent intent2 = new Intent(getApplicationContext(), YTVideo3.class);
