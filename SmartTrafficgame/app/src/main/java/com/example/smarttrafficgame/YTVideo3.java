...
public class YTVideo3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = findViewById(R.id.btnsumbit3);
        listView = findViewById(R.id.listQuestionView3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String rs=Network.connect("http://"+Network.IP+"/level4_ans.php",m);
                if (rs != "0") {
                    ...
                    Toast.makeText(YTVideo3.this, "Failed to submit answers. Please try again later.", Toast.LENGTH_SHORT).show();
                }
            }
        });

        String response = Network.connect("http://" + Network.IP + "/environment.php",
