...
public class YTvideows1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ytvideows1);
        button = findViewById(R.id.btnsumbit);
        listView = findViewById(R.id.listQuestionView1);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String rs=Network.connect("http://"+Network.IP+"/level2_ans.php",m);
                if (rs != "0") {
                    ...
                    Toast.makeText(YTvideows1.this, "Failed to submit answers. Please try again later.", Toast.LENGTH_SHORT).show();
                }
            }
        });

        String response = Network.connect("http://" + Network.IP + "/good_habits.php",
        ...
        System.out.println(busDataList+" 5225" );
