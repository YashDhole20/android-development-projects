...
public class Certi2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_certi2);

        name=findViewById(R.id.nameTextView1);
        date=findViewById(R.id.dateTextView1);
        grade=findViewById(R.id.gradeTextView1);
        cert=findViewById(R.id.certificateImage1);
        sign=findViewById(R.id.signTextView1);
        String id=getIntent().getStringExtra("id");
        Button btn=findViewById(R.id.next1);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), YTVideo2.class);
