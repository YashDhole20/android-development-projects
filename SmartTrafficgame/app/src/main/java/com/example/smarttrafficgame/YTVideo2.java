...
public class YTVideo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ytvideo2);
        button = findViewById(R.id.btnsumbit2);
        listView = findViewById(R.id.listQuestionView2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String rs=Network.connect("http://"+Network.IP+"/level3_ans.php",m);
                if (rs != "0") {
                    ...
                    Toast.makeText(YTVideo2.this, "Failed to submit answers. Please try again later.", Toast.LENGTH_SHORT).show();
                }
            }
        });

        String response = Network.connect("http://" + Network.IP + "/food.php",
