...
public class Certi3 extends AppCompatActivity {
    TextView name,date,grade;
    ImageView cert,sign;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_certi3);

         name=findViewById(R.id.nameTextView2);
        date=findViewById(R.id.dateTextView2);
        grade=findViewById(R.id.gradeTextView2);
        cert=findViewById(R.id.certificateImage2);
        sign=findViewById(R.id.signTextView2);
        String id=getIntent().getStringExtra("id");
        Button btn=findViewById(R.id.next2);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), YTVideo3.class);
