...
//    TechnicalAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.technicalround_activity);

        listView = findViewById(R.id.listQuestionView);
...
//        adapter = new TechnicalAdapter(this, questions);
...
//                });
    ...
    private void executeAfterDelay() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent rs = new Intent(technical.this, technical_result.class);
    ...
    private class GetQuestionsTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("http://192.168.1.4/Smartaptitude/get_questions.php");
    ...
    private void sendSelectedAnswersToServer() {
        ...
        for (String question : selectedOptions.keySet()) {
            ...
            try {
                ...
                selectedAnswerJsonObject.put("user_id", userId);
...
//
//        JSONArray selectedAnswersJsonArray = new JSONArray();
//        for (String[] selectedOption : selectedAnswers) {
//            JSONObject selectedAnswerJsonObject = new JSONObject();
//            try {
//                selectedAnswerJsonObject.put("question", selectedOption[0]);
//                selectedAnswerJsonObject.put("selected_option", selectedOption[1]);
//                selectedAnswersJsonArray.put(selectedAnswerJsonObject);
//            } catch (JSONException e) {
//                e.printStackTrace();
//            }
...
//    }
    ...
    private class SendAnswersToServerTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... jsonData) {
            try {
                URL url = new URL("http://192.168.1.4/Smartaptitude/technical_answer.php");
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
