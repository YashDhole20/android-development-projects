...
public class coding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.coding_round);

        listView = findViewById(R.id.codingquestion);
...
//        };
    ...
    private void executeAfterDelay() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent rs = new Intent(coding.this, ResultActivity.class);
    ...
    private class GetQuestionsTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("http://192.168.1.4/Smartaptitude/coding_questions.php");
    ...
    private class SendAnswersToServerTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... jsonData) {
            try {
                URL url = new URL("http://192.168.1.4/Smartaptitude/coding_answer.php");
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
