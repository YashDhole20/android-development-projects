...
public class LoginOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(v -> {
            ...
            if (verificationCode.equals(enteredOtp)) {
                ...
                Toast.makeText(LoginOtp.this, "Invalid OTP. Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                Toast.makeText(LoginOtp.this, "OTP verification failed"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                setInProgress(false);
                            }
    ...
    void signIn(PhoneAuthCredential phoneAuthCredential){
        ...
        setInProgress(true);
        Intent intent = new Intent(LoginOtp.this,AdminPanel.class);
        Toast.makeText(LoginOtp.this, "Registeration Successfully", Toast.LENGTH_SHORT).show();
