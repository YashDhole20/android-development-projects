...
public class PresentStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studDetails=findViewById(R.id.idViewModelPresent);


        StrictMode.ThreadPolicy policy=new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);

        String rs=Network.connect("http://"+Network.IP+"/presentStudentnew.php",new HashMap<String, String>());
